...
DnD Companion `.cursor/rules/` paketinden türetilmiş **4 katmanlı** model. Numara aralıkları ve dosya adları projeye göre uyarlanır.
...
## Context bütçesi (DnD Companion ölçümü)
